...
def start_election():
    ...
    while True:
        ...
        # Verificar si hay un líder activo antes de lanzar una elección
        if ROLE == 'follower' and (time.time() - LAST_HEARTBEAT) > TIMEOUT:
            ...
            vote_count = 1  # El candidato se vota a sí mismo
            ...
            # Convertirse en líder solo si se obtienen suficientes votos
